...
"
            >
              ...
              India. The company initially started with a small team and focused
              on providing software services to customers. As a software
              company, Valour Infotech specializes in the development and
              delivery of software solutions for businesses and industries.
              Their services include software development, web development,
            ...
            <p className="Aboutus1">
              ...
              needs and provide customized solutions to meet their specific
              needs. Apart from software development, Valour Infotech also
              offers other services such as IT consulting, project management
              and quality assurance. This new role ensures that software
              solutions delivered are of high quality and aligned with clients’
              business objectives.
            </p>
          </Col>
          <Col lg={6} md={6} sm={12}>
            <div className="d-flex justify-content-center">
              <img
                src="https://ml85xkxbvpuq.i.optimole.com/cb:pIqd.8ad3/w:500/h:500/q:mauto/f:avif/https://orbishinfotech.com/wp-content/uploads/2023/06/how-orbish-infotech-work-software-field.webp"
                alt="Error"
              />
            </div>
          </Col>
        ...
        <Row>
          <Col lg={6} md={6} sm={12}>
            <div className="d-flex justify-content-center">
              <img
                src="https://ml85xkxbvpuq.i.optimole.com/cb:pIqd.8ad3/w:466/h:356/q:mauto/f:avif/https://orbishinfotech.com/wp-content/uploads/2023/06/1-software-working-process.webp"
                alt="Error"
              />
            </div>
          </Col>
          <Col lg={6} md={6} sm={12}>
            ...
            <p className="text-dark-emphasis">
              ...
              delivering high-quality and innovative software products,valour
              Infotech offers solutions for software development, Website
            ...
            <p className="text-dark-emphasis">
              ...
              strive to meet the diverse needs of their clients. Whether it’s a
              small-scale business or a large enterprise, valour Infotech offers
        ...
        <Row>
          <Col lg={6} md={6} sm={12}>
            ...
            <p className="text-dark-emphasis">
              ...
              we work intimately with our clients to figure out their
            ...
            <p className="text-dark-emphasis">
              ...
              accept that these qualities are fundamental for building solid and
              enduring associations with our clients.
            </p>
          </Col>
          <Col lg={6} md={6} sm={12}>
            <div className="d-flex justify-content-center">
              <img
                src="https://ml85xkxbvpuq.i.optimole.com/cb:pIqd.8ad3/w:569/h:303/q:mauto/f:avif/https://orbishinfotech.com/wp-content/uploads/2023/06/orbish-infotech-mission.webp"
                alt="Error"
              />
            </div>
          </Col>
        ...
        <Row>
          <Col lg={6} md={6} sm={12}>
            <div className="d-flex justify-content-center">
              <img
                src="https://ml85xkxbvpuq.i.optimole.com/cb:pIqd.8ad3/w:569/h:370/q:mauto/f:avif/https://orbishinfotech.com/wp-content/uploads/2023/06/orbish-infotech-vision.webp"
                alt="Error"
              />
            </div>
          </Col>
