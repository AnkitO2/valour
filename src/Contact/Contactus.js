      ...
      <Row className="mt-5">
        <Col>
          ...
          <p className="text-dark-emphasis">
            We created this form for your feedback and related issues in
            whatever format it may be. Your suggestions are very much of value
            ...
            <div className="d-flex justify-content-between gap-4">
              ...
              <FormGroup className="mt-2">
                ...
                <Input id="exampleSelect" name="select" type="select">
                  ...
                  <option>E-Commers Devlopment</option>
        ...
        <Col>
          <div className="bg-primary p-5">
            ...
            <p className="text-white">
              We appreciate your visit and your interest in our services. Please
              fill out and submit the form below. Our representative will
              contact you shortly to discuss your technical requirements.
            </p>
            <h5 className="text-black">OFFICE ADDRESS</h5>
            <p className="text-white">
              Regd.off.HN 42-A Ran Ashrey Purwa
              ,Khargapur,Gomtinagar,Lucknow-226010 Uttar Pradesh
            </p>
